...
%   use_n0star  Flag to use N0star beside IWC. Default is false. 
...
if nargin < 2, O = []; end
%
if ~isfield(O,'use_n0star'), O.use_n0star = true;                  end
if ~isfield(O,'icehabit'),     O.icehabit = 'LargePlateAggregate'; end
if ~isfield(O,'icepsd'),         O.icepsd = 'psd_dardar2mom.arts'; end
...
%
adopt_dardar_iwc( P, F, O.use_n0star );    

...
#%%    
    ...
    ta_test.to_netcdf('/home/inderpreet/Dendrite/Projects/IWP/GMI/training_data/TB_GMI_test_jan_lpa.nc', 'w')
    
    ta_train = divide_test_train(ta, randomList[lim:])
    ta_train.to_netcdf('/home/inderpreet/Dendrite/Projects/IWP/GMI/training_data/TB_GMI_train_jan_lpa.nc', 'w')
